...
<head>
    ...
    <!-- Favicon -->
    <link href="estore/img/favicon.ico" rel="icon">
    ...
    <link href="estore/lib/slick/slick.css" rel="stylesheet">
    <link href="estore/lib/slick/slick-theme.css" rel="stylesheet">
            ...
            <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto">
                        ...
                        <a href="{{('/product_list')}}" class="nav-item nav-link">Products</a>
                        <a href="{{('/product_deatils')}}" class="nav-item nav-link">Product Detail</a>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <!-- <a href="{{('/estore_register')}}" class="dropdown-item">Login & Register</a> -->
                     ...
                     <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                                   <!--  
                                    ...
                                    <a class="nav-link" href="estore_login">{{ __('Login') }}</a>
                                    
                                    @if (Route::has('register'))
                                    
                                    <a class="nav-link" href="/estore_register">{{ __('Register') }}</a>
...
<!-- Footer Bottom Start -->
        ...
        <script src="estore/lib/easing/easing.min.js"></script>
        <script src="estore/lib/slick/slick.min.js"></script>
        
        <!-- Template Javascript -->
        <script src="estore/js/main.js"></script>
    </body>
    </html>
