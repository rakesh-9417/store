                ...
                <div class="row align-items-center">
                    <div class="col-md-5">
                        <div class="product-slider-single normal-slider">
                            <img src="products/{{ $val->image}}" alt="Product Image" style=" min-height:270px;  max-height:270px; ">
                                ...
                                <div class="col-md-7">
                                    <div class="product-content">
                                        <div class="title"><h2>{{ $val->prouct_name }}</h2></div>
                                        <div class="ratting">
                                        ...
                                        <div class="action">
                                            <form  action="/addtocart" method ="post" enctype="multipart/form-data">
                                                ...
                                                <input type="hidden" name="prouct_name" value="{{ $val->prouct_name }}">
                                                <input type="hidden" name="price" value="{{ $val->price }}">
                                                <button type="submit" class="btn btn-default" id="butsave"><i class="fa fa-shopping-cart"></i>Add to Cart</button>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="tab-content">
                                <div id="description" class="container tab-pane active">
                                    ...
                                    <p>
                                        {{ $val->id }}Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
